...
@section('content')
    ...
    <div class="col-md-6">
        ...
        <div class="card card-round mb-3">
            ...
            <form method="GET" action="{{ route('admin.v_dashboard') }}" class="form-inline mb-3">
                ...
                <button type="submit" class="btn btn-success" style="margin-left: 10px; width: 97%;">Filter</button>
            </form>
            <div class="card-body">
