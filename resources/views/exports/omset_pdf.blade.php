...
<head>
    <meta charset="UTF-8">
    <title>Laporan Omset Bulan {{ $bulan ? DateTime::createFromFormat('!m', $bulan)->format('F') : 'Semua Bulan' }} {{ $tahun }}</title>
    <style>
    ...
    <table>
        ...
        <tbody>
            @php 
                ...
                $totalLaba = 0;
            @endphp
            @foreach($transaksiDetail as $index => $row)
                @php
